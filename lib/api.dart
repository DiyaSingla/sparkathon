...
//   Dataset({required this.S_no, required this.brand, required this.product_name, required this.weight, required this.screen_size, required this.product_lifetime, required this.energy_demand, required this.assembly_location, required this.use_location, required this.manufacturing_impact, required this.transportation_impact, required this.end_of_life_impact, required this.use_impact, required this.carbon_footprint, required this.price})
...
//     final response= await http.get(Uri.parse('https://script.google.com/macros/s/AKfycbw08tF8pg8Qi4-uwyqeZKefbTb2OWAKhVydTCBSLgqhJ5y59gpTBvcIX-LwKpX7RfTRRg/exec'));
